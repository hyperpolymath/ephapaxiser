...
Replace all {{PLACEHOLDER}} values with your information:
  ephapaxiser     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  ephapaxiser             - Repository name
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/ephapaxiser/security/advisories/new)
...
- This repository (`hyperpolymath/ephapaxiser`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/ephapaxiser/security/advisories)
...
When using ephapaxiser, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/ephapaxiser/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/ephapaxiser/security/advisories/new) or {{SECURITY_EMAIL}} |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/ephapaxiser/discussions) |
...
*Thank you for helping keep ephapaxiser and its users safe.* 🛡️
